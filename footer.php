<footer>
    <div class="container">
        ...
        <div class="social">
            ...
            <div class="links">
                <a href="<? the_field( 'cсылка-инстраграм', 17 ) ?>" target="_blank"></a>
                <a href="<? the_field( 'cсылка-твиттер', 17 ) ?>" target="_blank"></a>
                <a href="<? the_field( 'cсылка-фейсбук', 17 ) ?>" target="_blank"></a>
                <a href="<? the_field( 'cсылка-vk', 17 ) ?>" target="_blank"></a>
                <a href="<? the_field( 'cсылка-linkedin', 17 ) ?>" target="_blank"></a>
            </div>
